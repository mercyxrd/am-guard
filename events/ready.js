...
module.exports = client => {
  client.user.setPresence({ activity: { name: `` + client.guilds.cache.size + ` adet sunucuya ve ` + client.guilds.cache.reduce((a, b) => a + b.memberCount, 0).toLocaleString() + ` kullanıcıya hizmet veriliyor!`  }, status: "dnd" });
